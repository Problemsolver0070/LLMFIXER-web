 ...
 * Each section reveals via IntersectionObserver as the user scrolls.
 *
 * The cosmos engine in the background continues drifting and responds
 * to scroll progress (color shift toward warm + outward radial drift)
 * via the ScrollBridge → onScrollUpdate → engine pipeline.
 */
